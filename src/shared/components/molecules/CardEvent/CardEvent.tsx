...
import { TypographyH3, TypographySmall } from '@shadcn/components/Typography';
        ...
        <CardContent className="flex w-full flex-wrap justify-center ">
          <div className="basis-full md:basis-1/2 flex justify-center z-10">
            <div className="flex flex-col gap-8 w-full justify-between">
                ...
                <div className="flex flex-wrap gap-10">
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <TypographyH3>{dateLongFormat(event.date)}</TypographyH3>
                    </div>
                  </div>
                  <div>
                    <TypographySmall>
              ...
              <div className="text-center ">
                ...
                <div
                  className={
                    'w-full flex justify-center mt-10 mb-4 xl:mb-0 ' +
                    (new Date(event.date) > new Date() ? '' : ' hidden')
                  }
                >
                  <a
          ...
          <div className="basis-full md:basis-1/2 flex justify-center items-center z-10">
            <div className="border rounded-xl overflow-hidden max-w-[500px]">
              <img src={event.imageUrl} style={{ objectFit: 'contain' }}></img>
            </div>
          </div>
        </CardContent>
      </Card>
